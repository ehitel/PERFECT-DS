...
namespace DS
{
    public partial class MaestroCategorias : Form, IWindow
    {
        ...
        void cargarDatos()
        {
            ...
            catch (Exception ex)
            {
                ...
                ErrorEstructura error = new ErrorEstructura
                {
                    ...
                    Titulo = "Error cargando categorias",
        ...
        private void ultraToolbarsManager1_ToolClick(object sender, Infragistics.Win.UltraWinToolbars.ToolClickEventArgs e)
        {
            switch (e.Tool.Key)
            {
                case "agregarRegistro":
                    ...
                    MaestroCategoriasMantenimiento mantenimiento = new MaestroCategoriasMantenimiento();
        ...
        private void ultraGrid1_ClickCellButton(object sender, Infragistics.Win.UltraWinGrid.CellEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    Tipo = TipoError.Error,
                    Titulo = "Error seleccionadno categorias",
                    Seccion = "Selección de categoría",
                    Comentario = "Puede tratarse de un problema momentáneo de conexión, por favor volver a intentar",
                    Mensaje = ex.Message,
                    Trazo = ex.StackTrace
                };
        ...
        void borrarRegistro(string codigoCategoria)
        {
            try
            {
                ...
                if (res.Resultado == TipoResultado.Error)
                {
                    ...
                    {
                        Tipo = TipoError.Error,
                        Titulo = "Error borrando categoría",
